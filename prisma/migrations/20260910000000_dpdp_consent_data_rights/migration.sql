...
-- Migration recorded after schema push (shadow DB had baseline mismatch).
...
ALTER TABLE "DataRightsRequest" ADD CONSTRAINT "DataRightsRequest_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
