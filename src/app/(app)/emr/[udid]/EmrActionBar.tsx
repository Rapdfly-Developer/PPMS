...
export function EmrActionBar({
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 lg:left-60 right-0 z-20 border-t border-[var(--color-border)] bg-white/95 backdrop-blur-sm px-4 md:px-8 py-3 flex flex-wrap items-center justify-end gap-2 md:gap-3 shadow-[0_-4px_16px_rgba(20,36,43,0.06)]">
        {!closed && !isLastTab && (
          <button
