                  ...
                  <div className="flex flex-col gap-2">
                    {items.map((r, idx) => {
                      ...
                      return (
                        <div
                          key={r.id}
                          className="flex items-start gap-4 px-4 py-4 rounded-xl border border-[var(--color-border)] bg-white"
                        >
                          {/* Serial */}
                            ...
                            <div className="flex items-start justify-between gap-2 flex-wrap mb-1.5">
                              <div className="flex items-center gap-2 flex-wrap">
                                <Link
                                  ...
                                  className="text-sm font-semibold text-[var(--color-ink-900)] hover:text-[var(--color-primary-700)] hover:underline transition-colors"
                                >
                                  {r.patient.name}
                                </Link>
                                <span className="text-xs text-[var(--color-ink-400)]">
