      ...
      {surgeryAdvisedVisitId && (
        ...
        >
          ...
          <div className="px-4 py-3 flex flex-col gap-2.5">
            {surgeryAdvisedDate && (
              <p className="text-[9px] sm:text-[10px] font-semibold text-teal-600 uppercase tracking-widest">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2">
              {surgeryAdvisedName && (
                <div>
                  <p className="text-[9px] sm:text-[10px] font-bold text-teal-700 uppercase tracking-wide mb-0.5">Procedure</p>
                  <p className="text-[13px] sm:text-sm font-medium text-teal-900">{surgeryAdvisedName}</p>
                </div>
              )}
              {surgeryAdvisedEye && (
                <div>
                  <p className="text-[9px] sm:text-[10px] font-bold text-teal-700 uppercase tracking-wide mb-0.5">Eye</p>
            ...
            {surgeryAdvisedNotes && (
              <div>
                <p className="text-[9px] sm:text-[10px] font-bold text-teal-700 uppercase tracking-wide mb-0.5">Counselling Notes</p>
