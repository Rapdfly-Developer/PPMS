...
import { Mail, Phone, MapPin, ShieldCheck, Lock, Database, Users, History, FileText, AlertCircle, Eye, Trash2, RefreshCw } from "lucide-react";
...
const LAST_UPDATED = "23 September 2025";
...
function SectionCard({
  ...
  return (
    ...
    >
      ...
      <div className="prose-pp">{children}</div>
    </section>
  );
}
      ...
      <div className="border-b border-emerald-950/[0.07] bg-white px-4 pb-10 pt-28 sm:px-6 sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-slate-500">
            RF Health is operated by <strong className="font-semibold text-emerald-950">RAPDFLY PRIVATE LIMITED</strong>.
        ...
        <div className="flex gap-10 lg:items-start">
          ...
          <div className="min-w-0 flex-1 flex flex-col gap-5">
            ...
            <SectionCard id="overview" icon={<FileText size={16} strokeWidth={1.5} />} title="Overview">
              ...
              <P>
                <strong className="font-semibold text-emerald-950">Data fiduciary:</strong> RAPDFLY PRIVATE LIMITED
                determines the purpose and means of processing personal data collected through RF Health.
              </P>
              <P>
            ...
            <SectionCard id="ai-processing" icon={<RefreshCw size={16} strokeWidth={1.5} />} title="Clinical AI processing">
              <P>
                RF Health includes an optional feature called the <strong className="font-semibold text-emerald-950">Clinical Copilot</strong>.
