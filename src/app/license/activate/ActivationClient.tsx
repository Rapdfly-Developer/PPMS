        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs mt-1" style={{ color: "rgba(255,255,255,.45)" }}>Activate your PPMS license to continue using the application.</p>
            </div>
          </div>
          ...
          <Card title="Activate Your License" icon={Key}>
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-semibold mb-1.5" style={{ color: "rgba(255,255,255,.55)" }}>PPMS Version</label>
        ...
        <Card>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-[10px] uppercase tracking-wide font-semibold" style={{ color: "rgba(255,255,255,.35)" }}>PPMS Version</p>
