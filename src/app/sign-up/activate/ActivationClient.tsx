    ...
    <div className="min-h-screen" style={{ background: "linear-gradient(110deg, #f0fcfa 0%, #dcf5f1 60%, #c8eee9 100%)" }}>
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <Link href="/sign-up" className="self-start inline-flex items-center gap-1.5 text-xs font-medium text-slate-500 hover:text-[#115E59] mb-6">
          ...
          <Card title="License Holder" icon={UserCircle}>
            {data.orgId ? (
              ...
              <div className="flex flex-col items-center py-8 text-center">
                ...
                <Link href="/sign-up" className="mt-3 text-xs font-semibold hover:underline" style={{ color: TEAL }}>
                  Start a free trial →
                </Link>
              </div>
            )}
